...
function Movies() {
  ...
  const url = `https://api.themoviedb.org/3/discover/movie?api_key=b438eb3479c6e4729b05c73cbe88e602&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${currentPage}`;
  useEffect(() => {
    window.scroll(0, 0);
    fetch(url)
      .then((res) => res.json())
